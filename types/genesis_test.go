...
func TestGenesisBad(t *testing.T) {
	...
	testCases := [][]byte{
		...
		[]byte(`{"chain_id":"mychain"}`),                   // missing validators
		[]byte(`{"validators":[{"pub_key":{"type":"Demars-DMC/PubKeyEd25519","value":"AT/+aaL1eB0477Mud9JMm8Sh8BIvOYlPGC9KkIUmFaE="},"power":"10","name":""}]}`), // missing chain_id
	}
...
func TestGenesisGood(t *testing.T) {
	...
	genDocBytes := []byte(`{"genesis_time":"0001-01-01T00:00:00Z","chain_id":"test-chain-QDKdJr","consensus_params":null,"validators":[{"pub_key":{"type":"Demars-DMC/PubKeyEd25519","value":"AT/+aaL1eB0477Mud9JMm8Sh8BIvOYlPGC9KkIUmFaE="},"power":"10","name":""}],"app_hash":"","app_state":{"account_owner": "Bob"}}`)

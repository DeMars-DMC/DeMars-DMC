...
var checkTxCmd = &cobra.Command{
	Use:   "check_tx",
	Short: "validate a DMC transaction",
	Long:  "validate a DMC transaction",
	Args:  cobra.ExactArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
...
func cmdTest(cmd *cobra.Command, args []string) error {
	return compose(
		[]func() error{
			...
			func() error { return servertest.DeliverTx(client, []byte("abc"), 1, code.CodeTypeBadNonce, nil) },
			func() error { return servertest.Commit(client, nil) },
			func() error { return servertest.DeliverTx(client, []byte{0x00}, 1, code.CodeTypeOK, nil) },
			func() error { return servertest.Commit(client, []byte{0, 0, 0, 0, 0, 0, 0, 1}) },
			func() error { return servertest.DeliverTx(client, []byte{0x00}, 1, code.CodeTypeBadNonce, nil) },
			func() error { return servertest.DeliverTx(client, []byte{0x01}, 1, code.CodeTypeOK, nil) },
			func() error { return servertest.DeliverTx(client, []byte{0x00, 0x02}, 1, code.CodeTypeOK, nil) },
			func() error { return servertest.DeliverTx(client, []byte{0x00, 0x03}, 1, code.CodeTypeOK, nil) },
			func() error { return servertest.DeliverTx(client, []byte{0x00, 0x00, 0x04}, 1, code.CodeTypeOK, nil) },
			func() error {
				return servertest.DeliverTx(client, []byte{0x00, 0x00, 0x06}, 1, code.CodeTypeBadNonce, nil)
			},
...
func cmdDeliverTx(cmd *cobra.Command, args []string) error {
	...
	res, err := client.DeliverTxSync(txBytes, height)
	if err != nil {
		return err
	}
	printResponse(cmd, args, response{
...
func cmdCheckTx(cmd *cobra.Command, args []string) error {
	...
	res, err := client.CheckTxSync(txBytes, height)
	if err != nil {
		return err
	}
	printResponse(cmd, args, response{

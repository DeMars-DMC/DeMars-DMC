...
echo "starting Demars-DMC peer ID=$ID"
# start Demars-DMC container on the network
...
docker run -d \
	...
	-e TMHOME="/go/src/github.com/Demars-DMC/Demars-DMC/test/p2p/data/mach$ID/core" \
	--log-driver=syslog \

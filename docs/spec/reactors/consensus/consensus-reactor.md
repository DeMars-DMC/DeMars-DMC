...
manages the state of the DéMars consensus internal state machine.
...
Consensus State handles execution of the DéMars BFT consensus algorithm. It processes votes and proposals, 
